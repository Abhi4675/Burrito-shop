        ...
        return (
            <div style={{ display: 'flex', justifyContent: 'center', padding: 30 }}>
                ...
                <ul className="list-group">
                    <li>This project uses MERN - MongoDB, Express, React and Node - stack to implement a Burrito shop.<br />
                    It offers the following functionalities:</li>
                    <ul>
                ...
                <ul className="list-group">
                    <li>Lists the available Burrito products in the system</li>
                    <ul>
                        <li>The user can search on the basis of category and item name.</li>
                        <li>Search and Filtering are integrated together.</li>
                    </ul>
                </ul>
                <ul className="list-group">
                    <li>Paging functionality is provided for listing the products.</li>
                    <ul>
                ...
                <ul className="list-group">
                    <li>Admin user can do 2 types of delete</li>
                    <ul>
